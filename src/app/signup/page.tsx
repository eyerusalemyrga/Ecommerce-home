      ...
      <div className="flex flex-1 items-center justify-center gap-12 px-8">
        ...
        <div className="w-[400px] flex flex-col gap-6 bg-white p-8 rounded-lg shadow">
          ...
          <div className="text-center mt-2 text-sm">
            Already have account? <Link href="/login" className="text-[#DB4444] font-semibold">Login</Link>
          </div>
        </div>
      </div>
      {}
        ...
        <div>
          ...
          <div>
            ...
            <div className="flex gap-2">
              {}
              <Image src="/images/qr code.jpg" alt="QR" width={30} height={10} />
              <Image src="/images/app store.jpg" alt="App store" width={30} height={10} />
              <Image src="/images/google play.jpg" alt="Google Play" width={30} height={10} />
            </div>
